...
### Directory and time
directory = '/home/zlabe/Documents/Projects/SeaIceExtent/Results/'
source = 'proposal'
...
#plt.legend(shadow=False,fontsize=10,loc='upper left',
#           bbox_to_anchor=(0.83, 1.05),fancybox=True)
...
if source != 'proposal':
    ...
    a = plt.axes([.2, .21, .25, .25], axisbg='w')
...
if source == 'proposal':  
    ...
    plt.savefig(directory + 'JAXAseaice%s_presentation.png' % currenttime ,dpi=500)
